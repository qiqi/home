...
for i in range(1001):
  ...
  for istage in range(nstage):
    ...
    for jstage in range(istage + 1):
      u += du[:,jstage] * dt * stages.beta[istage][jstage]
# os.system('mencoder mf://periodic_interp_*.png -mf type=png:fps=10 -ovc lavc ' + \
#           '-lavcopts vcodec=mpeg4:mbd=2:trell -oac copy -o periodic_interp.avi')
# os.system('rm -rf periodic_interp_*.png')
