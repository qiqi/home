...
class MonoLeg:
   ...
   def calc_C_matrix(self, dt):
      ...
      self._C[6:8,8] = -cos_arms[2] + dt/2.0 * sin_arms[2] * self._a_vel[2], \
                        sin_arms[2] + dt/2.0 * cos_arms[2] * self._a_vel[2]
