import numpy
from numpy import zeros, ones, logical_or, log2, sqrt
...
def multigrid(source, bcmask):
   ...
   for i in range(NITER1):
      ...
      phi -= res / 4.0
   # coarse grid, range(1) is V-cycle, range(2) is W-cycle
...
def poisson(source, bcmask, bcvalue, rel_res=1.0E-9):
   ...
   while resmag / resmag0 > rel_res:
      ...
      niter += 1
      resmag = sqrt((res**2).sum())
      print niter, resmag / resmag0
      relres.append(resmag / resmag0)
